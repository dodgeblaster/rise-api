...
exports.getRemoveStatus = void 0;
 ...
 */
function getCloudFormationStackInfo(getInfo) {
...
function checkAgainState(io, config, timer, times) {
    return __awaiter(this, void 0, void 0, function () {
        var wait, increasedTimer, newTimer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wait = function (time) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, getCloudFormationStackInfo(io.getInfo)];
                case 2:
                    stackInfo = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _a.sent();
                    if (times > 1 && e_1.message.includes('does not exist')) {
                        return [2 /*return*/, {
                                status: 'success',
                ...
                case 4:
                    ...
                    if (!stackInfo.status.includes('PROGRESS')) return [3 /*break*/, 6];
...
function getRemoveStatus(props) {
    return __awaiter(this, void 0, void 0, function () {
        var aws, region;
        return __generator(this, function (_a) {
...
exports.getRemoveStatus = getRemoveStatus;
