...
exports.makeBuildProject = void 0;
function makeBuildProject(props) {
    var _a;
    var envVariables = Object.keys(props.env).map(function (k) {
        return {
            Name: k,
            Value: props.env[k]
        };
...
exports.makeBuildProject = makeBuildProject;
