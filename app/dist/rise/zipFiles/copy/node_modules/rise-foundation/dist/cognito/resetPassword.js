...
var cognito = new aws_sdk_1.default.CognitoIdentityServiceProvider({
    region: process.env.REGION || 'us-east-1'
});
function resetPassword(props) {
    return __awaiter(this, void 0, void 0, function () {
        var pass, params, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    pass = (0, password_1.makePassword)();
                    params = {
                        Password: pass,
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, cognito.adminSetUserPassword(params).promise()];
                case 2:
                    _a.sent();
                    return [2 /*return*/, {
                            email: props.email,
