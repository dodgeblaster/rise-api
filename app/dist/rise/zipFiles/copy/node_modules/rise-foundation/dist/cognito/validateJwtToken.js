...
var cacheKeys;
var getPublicKeys = function (cognitoIssuer) { return __awaiter(void 0, void 0, void 0, function () {
    var url, publicKeys;
...
var verifyPromised = (0, util_1.promisify)(jsonwebtoken.verify.bind(jsonwebtoken));
function validateToken(props) {
    return __awaiter(this, void 0, void 0, function () {
        var cognitoPoolId, cognitoIssuer, result, token, tokenSections, headerJSON, header, keys, key, claim, currentSeconds, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    cognitoPoolId = process.env.COGNITO_POOL_ID || props.userPoolId;
                    if (!cognitoPoolId) {
                        throw new Error('env var required for cognito pool');
                    }
                    cognitoIssuer = "https://cognito-idp.us-east-1.amazonaws.com/" + cognitoPoolId;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    ...
                    return [4 /*yield*/, getPublicKeys(cognitoIssuer)];
                case 2:
                    keys = _a.sent();
                    key = keys[header.kid];
                    if (key === undefined) {
                ...
                case 4:
                    error_1 = _a.sent();
                    result = { userName: '', clientId: '', error: error_1, isValid: false };
                    return [3 /*break*/, 5];
